...
//Slider template
if ( ! function_exists( 'wildbeyond_slider_template' ) ) :
function wildbeyond_slider_template() {
    ...
    $button     = wildbeyond_slider_button();
    $mobile_slider = get_theme_mod('mobile_slider', 'responsive');

    //Slider text
    if ( !function_exists('pll_register_string') ) {
    	$titles = array(
    		'slider_title_1' => get_theme_mod('slider_title_1', 'Welcome to WildBeyond'),
    	...
    	$titles = array(
    		'slider_title_1' => pll__( get_theme_mod('slider_title_1', 'Welcome to WildBeyond') ),
      ...
      <a href="#" class="prev"><i class="fa fa-angle-left"></i></a>
        ...
        <?php foreach ( $images as $image ) {
        	if ( $image ) {
                ...
                $image_alt = wildbeyond_get_image_alt( $image );
        		?>
...
function wildbeyond_slider_button() {
...
function wildbeyond_stop_text() {
    ...
    <div class="slide-inner text-slider-stopped">
        ...
        <?php echo wildbeyond_slider_button(); ?>
    </div>   
    <?php 
}